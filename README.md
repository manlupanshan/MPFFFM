...
4.Experimental Protocols: The preparation and fabrication procedures for the digital PCR (dPCR) chips, along with the operational and readout protocols for the microscopy system.

这个仓库包括我们论文的设计、加工、仿真代码及实验的细节。具体包括：

1.显微系统设计流程，及具体参数。

2.端到端相位板优化方法、约束算法设计及结果分析。Zemax与Matlab、Python串联的读取、写入代码。

3.重构算法代码及在环优化流程。

4.dPCR制备加工流程及显微系统操作读取流程。

I will improve this repository in my spare time.(我会在闲暇时间(也许有)逐渐完善这个仓库.)
